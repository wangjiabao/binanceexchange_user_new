...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xb4, 0x19, 0x0a,
...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_goTypes = []interface{}{
	...
	(*ListenTraderAndUserOrderRequest_SendBody)(nil),            // 36: ListenTraderAndUserOrderRequest.SendBody
	(*ListenTraderAndUserOrderRequest_SendBody_Order)(nil),      // 37: ListenTraderAndUserOrderRequest.SendBody.Order
	(*ListenTraderAndUserOrderRequest_SendBody_Order_Data)(nil), // 38: ListenTraderAndUserOrderRequest.SendBody.Order.Data
	(*GetBinanceTraderPositionHistoryReply_Position)(nil),       // 39: GetBinanceTraderPositionHistoryReply.Position
	(*GetFilDataReply_DataList)(nil),                            // 40: GetFilDataReply.DataList
}
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_depIdxs = []int32{
	36, // 0: ListenTraderAndUserOrderRequest.send_body:type_name -> ListenTraderAndUserOrderRequest.SendBody
	39, // 1: GetBinanceTraderPositionHistoryReply.positions:type_name -> GetBinanceTraderPositionHistoryReply.Position
	40, // 2: GetFilDataReply.list:type_name -> GetFilDataReply.DataList
	37, // 3: ListenTraderAndUserOrderRequest.SendBody.orders:type_name -> ListenTraderAndUserOrderRequest.SendBody.Order
	38, // 4: ListenTraderAndUserOrderRequest.SendBody.Order.data:type_name -> ListenTraderAndUserOrderRequest.SendBody.Order.Data
	40, // 5: GetFilDataReply.DataList.listChild:type_name -> GetFilDataReply.DataList
	0,  // 6: BinanceUser.GetUser:input_type -> GetUserRequest
	2,  // 7: BinanceUser.PullUserDeposit:input_type -> PullUserDepositRequest
	2,  // 8: BinanceUser.PullUserDeposit2:input_type -> PullUserDepositRequest
	4,  // 9: BinanceUser.PullUserCredentialsBsc:input_type -> PullUserCredentialsBscRequest
	6,  // 10: BinanceUser.BindTrader:input_type -> BindTraderRequest
	18, // 11: BinanceUser.ListenTraderAndUserOrder:input_type -> ListenTraderAndUserOrderRequest
	16, // 12: BinanceUser.OrderHandle:input_type -> OrderHandleRequest
	16, // 13: BinanceUser.OrderHandleTwo:input_type -> OrderHandleRequest
	8,  // 14: BinanceUser.Analyze:input_type -> AnalyzeRequest
	10, // 15: BinanceUser.CloseOrderAfterBind:input_type -> CloseOrderAfterBindRequest
	10, // 16: BinanceUser.CloseOrderAfterBindTwo:input_type -> CloseOrderAfterBindRequest
	12, // 17: BinanceUser.InitOrderAfterBind:input_type -> InitOrderAfterBindRequest
	12, // 18: BinanceUser.InitOrderAfterBindTwo:input_type -> InitOrderAfterBindRequest
	14, // 19: BinanceUser.OverOrderAfterBind:input_type -> OverOrderAfterBindRequest
	14, // 20: BinanceUser.OverOrderAfterBindTwo:input_type -> OverOrderAfterBindRequest
	14, // 21: BinanceUser.AdminOverOrderAfterBind:input_type -> OverOrderAfterBindRequest
	14, // 22: BinanceUser.AdminOverOrderAfterBindTwo:input_type -> OverOrderAfterBindRequest
	20, // 23: BinanceUser.PullTradingBoxOpen:input_type -> PullTradingBoxOpenRequest
	22, // 24: BinanceUser.SettleTradingBoxOpen:input_type -> SettleTradingBoxOpenRequest
	24, // 25: BinanceUser.PullBinanceTradeHistory:input_type -> PullBinanceTradeHistoryRequest
	26, // 26: BinanceUser.GetBinanceTraderPosition:input_type -> GetBinanceTraderPositionHistoryRequest
	29, // 27: BinanceUser.UserOrderDo:input_type -> UserOrderDoRequest
	31, // 28: BinanceUser.UserOrderDoHandlePrice:input_type -> UserOrderDoHandlePriceRequest
	33, // 29: BinanceUser.PullFilData:input_type -> PullFilDataRequest
	35, // 30: BinanceUser.GetFilData:input_type -> GetFilDataRequest
	1,  // 31: BinanceUser.GetUser:output_type -> GetUserReply
	3,  // 32: BinanceUser.PullUserDeposit:output_type -> PullUserDepositReply
	3,  // 33: BinanceUser.PullUserDeposit2:output_type -> PullUserDepositReply
	5,  // 34: BinanceUser.PullUserCredentialsBsc:output_type -> PullUserCredentialsBscReply
	7,  // 35: BinanceUser.BindTrader:output_type -> BindTraderReply
	19, // 36: BinanceUser.ListenTraderAndUserOrder:output_type -> ListenTraderAndUserOrderReply
	17, // 37: BinanceUser.OrderHandle:output_type -> OrderHandleReply
	17, // 38: BinanceUser.OrderHandleTwo:output_type -> OrderHandleReply
	9,  // 39: BinanceUser.Analyze:output_type -> AnalyzeReply
	11, // 40: BinanceUser.CloseOrderAfterBind:output_type -> CloseOrderAfterBindReply
	11, // 41: BinanceUser.CloseOrderAfterBindTwo:output_type -> CloseOrderAfterBindReply
	13, // 42: BinanceUser.InitOrderAfterBind:output_type -> InitOrderAfterBindReply
	13, // 43: BinanceUser.InitOrderAfterBindTwo:output_type -> InitOrderAfterBindReply
	15, // 44: BinanceUser.OverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 45: BinanceUser.OverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	15, // 46: BinanceUser.AdminOverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 47: BinanceUser.AdminOverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	21, // 48: BinanceUser.PullTradingBoxOpen:output_type -> PullTradingBoxOpenReply
	23, // 49: BinanceUser.SettleTradingBoxOpen:output_type -> SettleTradingBoxOpenReply
	25, // 50: BinanceUser.PullBinanceTradeHistory:output_type -> PullBinanceTradeHistoryReply
	27, // 51: BinanceUser.GetBinanceTraderPosition:output_type -> GetBinanceTraderPositionHistoryReply
	28, // 52: BinanceUser.UserOrderDo:output_type -> UserOrderDoReply
	30, // 53: BinanceUser.UserOrderDoHandlePrice:output_type -> UserOrderDoHandlePriceReply
	32, // 54: BinanceUser.PullFilData:output_type -> PullFilDataReply
	34, // 55: BinanceUser.GetFilData:output_type -> GetFilDataReply
