...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x32, 0xe8, 0x17, 0x0a, 0x0b, 0x42, 0x69, 0x6e,
	...
	,
...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_goTypes = []interface{}{
	...
	(*ListenTraderAndUserOrderRequest_SendBody)(nil),            // 32: ListenTraderAndUserOrderRequest.SendBody
	(*ListenTraderAndUserOrderRequest_SendBody_Order)(nil),      // 33: ListenTraderAndUserOrderRequest.SendBody.Order
	(*ListenTraderAndUserOrderRequest_SendBody_Order_Data)(nil), // 34: ListenTraderAndUserOrderRequest.SendBody.Order.Data
	(*GetBinanceTraderPositionHistoryReply_Position)(nil),       // 35: GetBinanceTraderPositionHistoryReply.Position
}
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_depIdxs = []int32{
	32, // 0: ListenTraderAndUserOrderRequest.send_body:type_name -> ListenTraderAndUserOrderRequest.SendBody
	35, // 1: GetBinanceTraderPositionHistoryReply.positions:type_name -> GetBinanceTraderPositionHistoryReply.Position
	33, // 2: ListenTraderAndUserOrderRequest.SendBody.orders:type_name -> ListenTraderAndUserOrderRequest.SendBody.Order
	34, // 3: ListenTraderAndUserOrderRequest.SendBody.Order.data:type_name -> ListenTraderAndUserOrderRequest.SendBody.Order.Data
	0,  // 4: BinanceUser.GetUser:input_type -> GetUserRequest
	2,  // 5: BinanceUser.PullUserDeposit:input_type -> PullUserDepositRequest
	2,  // 6: BinanceUser.PullUserDeposit2:input_type -> PullUserDepositRequest
	4,  // 7: BinanceUser.PullUserCredentialsBsc:input_type -> PullUserCredentialsBscRequest
	6,  // 8: BinanceUser.BindTrader:input_type -> BindTraderRequest
	18, // 9: BinanceUser.ListenTraderAndUserOrder:input_type -> ListenTraderAndUserOrderRequest
	16, // 10: BinanceUser.OrderHandle:input_type -> OrderHandleRequest
	16, // 11: BinanceUser.OrderHandleTwo:input_type -> OrderHandleRequest
	8,  // 12: BinanceUser.Analyze:input_type -> AnalyzeRequest
	10, // 13: BinanceUser.CloseOrderAfterBind:input_type -> CloseOrderAfterBindRequest
	10, // 14: BinanceUser.CloseOrderAfterBindTwo:input_type -> CloseOrderAfterBindRequest
	12, // 15: BinanceUser.InitOrderAfterBind:input_type -> InitOrderAfterBindRequest
	12, // 16: BinanceUser.InitOrderAfterBindTwo:input_type -> InitOrderAfterBindRequest
	14, // 17: BinanceUser.OverOrderAfterBind:input_type -> OverOrderAfterBindRequest
	14, // 18: BinanceUser.OverOrderAfterBindTwo:input_type -> OverOrderAfterBindRequest
	14, // 19: BinanceUser.AdminOverOrderAfterBind:input_type -> OverOrderAfterBindRequest
	14, // 20: BinanceUser.AdminOverOrderAfterBindTwo:input_type -> OverOrderAfterBindRequest
	20, // 21: BinanceUser.PullTradingBoxOpen:input_type -> PullTradingBoxOpenRequest
	22, // 22: BinanceUser.SettleTradingBoxOpen:input_type -> SettleTradingBoxOpenRequest
	24, // 23: BinanceUser.PullBinanceTradeHistory:input_type -> PullBinanceTradeHistoryRequest
	26, // 24: BinanceUser.GetBinanceTraderPosition:input_type -> GetBinanceTraderPositionHistoryRequest
	29, // 25: BinanceUser.UserOrderDo:input_type -> UserOrderDoRequest
	31, // 26: BinanceUser.UserOrderDoHandlePrice:input_type -> UserOrderDoHandlePriceRequest
	1,  // 27: BinanceUser.GetUser:output_type -> GetUserReply
	3,  // 28: BinanceUser.PullUserDeposit:output_type -> PullUserDepositReply
	3,  // 29: BinanceUser.PullUserDeposit2:output_type -> PullUserDepositReply
	5,  // 30: BinanceUser.PullUserCredentialsBsc:output_type -> PullUserCredentialsBscReply
	7,  // 31: BinanceUser.BindTrader:output_type -> BindTraderReply
	19, // 32: BinanceUser.ListenTraderAndUserOrder:output_type -> ListenTraderAndUserOrderReply
	17, // 33: BinanceUser.OrderHandle:output_type -> OrderHandleReply
	17, // 34: BinanceUser.OrderHandleTwo:output_type -> OrderHandleReply
	9,  // 35: BinanceUser.Analyze:output_type -> AnalyzeReply
	11, // 36: BinanceUser.CloseOrderAfterBind:output_type -> CloseOrderAfterBindReply
	11, // 37: BinanceUser.CloseOrderAfterBindTwo:output_type -> CloseOrderAfterBindReply
	13, // 38: BinanceUser.InitOrderAfterBind:output_type -> InitOrderAfterBindReply
	13, // 39: BinanceUser.InitOrderAfterBindTwo:output_type -> InitOrderAfterBindReply
	15, // 40: BinanceUser.OverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 41: BinanceUser.OverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	15, // 42: BinanceUser.AdminOverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 43: BinanceUser.AdminOverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	21, // 44: BinanceUser.PullTradingBoxOpen:output_type -> PullTradingBoxOpenReply
	23, // 45: BinanceUser.SettleTradingBoxOpen:output_type -> SettleTradingBoxOpenReply
	25, // 46: BinanceUser.PullBinanceTradeHistory:output_type -> PullBinanceTradeHistoryReply
	27, // 47: BinanceUser.GetBinanceTraderPosition:output_type -> GetBinanceTraderPositionHistoryReply
	28, // 48: BinanceUser.UserOrderDo:output_type -> UserOrderDoReply
	30, // 49: BinanceUser.UserOrderDoHandlePrice:output_type -> UserOrderDoHandlePriceReply
