...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_rawDesc = []byte{
	...
	0x65, 0x50, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xa0, 0x26, 0x0a, 0x0b, 0x42, 0x69, 0x6e, 0x61,
	...
	0x61, 0x6e, 0x63, 0x65, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x75, 0x73, 0x65,
	0x72, 0x2f, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x5f, 0x70, 0x42, 0x4b, 0x0a, 0x12, 0x61, 0x70,
...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_depIdxs = []int32{
	...
	14, // 26: BinanceUser.OverOrderAfterBind:input_type -> OverOrderAfterBindRequest
	14, // 27: BinanceUser.OverOrderAfterBindTwo:input_type -> OverOrderAfterBindRequest
	14, // 28: BinanceUser.AdminOverOrderAfterBind:input_type -> OverOrderAfterBindRequest
	14, // 29: BinanceUser.AdminOverOrderAfterBindTwo:input_type -> OverOrderAfterBindRequest
	16, // 30: BinanceUser.AdminOverOrderTwoByInfo:input_type -> AdminOverOrderTwoByInfoRequest
	18, // 31: BinanceUser.OrderAdminTwo:input_type -> OrderAdminTwoRequest
	20, // 32: BinanceUser.ExchangeUserLeverAge:input_type -> ExchangeUserLeverAgeRequest
	26, // 33: BinanceUser.PullTradingBoxOpen:input_type -> PullTradingBoxOpenRequest
	28, // 34: BinanceUser.SettleTradingBoxOpen:input_type -> SettleTradingBoxOpenRequest
	30, // 35: BinanceUser.PullBinanceTradeHistory:input_type -> PullBinanceTradeHistoryRequest
	32, // 36: BinanceUser.GetBinanceTraderPosition:input_type -> GetBinanceTraderPositionHistoryRequest
	35, // 37: BinanceUser.UserOrderDo:input_type -> UserOrderDoRequest
	35, // 38: BinanceUser.UserOrderDoTwo:input_type -> UserOrderDoRequest
	37, // 39: BinanceUser.UserOrderDoHandlePrice:input_type -> UserOrderDoHandlePriceRequest
	39, // 40: BinanceUser.PullFilData:input_type -> PullFilDataRequest
	41, // 41: BinanceUser.GetFilData:input_type -> GetFilDataRequest
	45, // 42: BinanceUser.GetUserBindData:input_type -> GetUserBindDataRequest
	43, // 43: BinanceUser.GetBinanceTradersTrade:input_type -> GetBinanceTradersTradeRequest
	46, // 44: BinanceUser.InsertUserBindData:input_type -> InsertUserBindDataRequest
	48, // 45: BinanceUser.DeleteUserBindData:input_type -> DeleteUserBindDataRequest
	50, // 46: BinanceUser.HandleP:input_type -> HandlePRequest
	1,  // 47: BinanceUser.GetUser:output_type -> GetUserReply
	3,  // 48: BinanceUser.PullUserDeposit:output_type -> PullUserDepositReply
	3,  // 49: BinanceUser.PullUserDeposit2:output_type -> PullUserDepositReply
	5,  // 50: BinanceUser.PullUserCredentialsBsc:output_type -> PullUserCredentialsBscReply
	7,  // 51: BinanceUser.BindTrader:output_type -> BindTraderReply
	25, // 52: BinanceUser.ListenTraderAndUserOrder:output_type -> ListenTraderAndUserOrderReply
	25, // 53: BinanceUser.ListenTraderAndUserOrderNew:output_type -> ListenTraderAndUserOrderReply
	25, // 54: BinanceUser.ListenOrderNew:output_type -> ListenTraderAndUserOrderReply
	23, // 55: BinanceUser.OrderHandle:output_type -> OrderHandleReply
	23, // 56: BinanceUser.OrderHandleTwo:output_type -> OrderHandleReply
	9,  // 57: BinanceUser.Analyze:output_type -> AnalyzeReply
	11, // 58: BinanceUser.CloseOrderAfterBind:output_type -> CloseOrderAfterBindReply
	11, // 59: BinanceUser.CloseOrderAfterBindTwo:output_type -> CloseOrderAfterBindReply
	13, // 60: BinanceUser.InitOrderAfterBind:output_type -> InitOrderAfterBindReply
	13, // 61: BinanceUser.InitOrderAfterBindTwo:output_type -> InitOrderAfterBindReply
	13, // 62: BinanceUser.InitOrderAfterBindTwoNew:output_type -> InitOrderAfterBindReply
	15, // 63: BinanceUser.OverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 64: BinanceUser.OverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	15, // 65: BinanceUser.AdminOverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 66: BinanceUser.AdminOverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	17, // 67: BinanceUser.AdminOverOrderTwoByInfo:output_type -> AdminOverOrderTwoByInfoReply
	19, // 68: BinanceUser.OrderAdminTwo:output_type -> OrderAdminTwoReply
	21, // 69: BinanceUser.ExchangeUserLeverAge:output_type -> ExchangeUserLeverAgeReply
	27, // 70: BinanceUser.PullTradingBoxOpen:output_type -> PullTradingBoxOpenReply
	29, // 71: BinanceUser.SettleTradingBoxOpen:output_type -> SettleTradingBoxOpenReply
	31, // 72: BinanceUser.PullBinanceTradeHistory:output_type -> PullBinanceTradeHistoryReply
	33, // 73: BinanceUser.GetBinanceTraderPosition:output_type -> GetBinanceTraderPositionHistoryReply
	34, // 74: BinanceUser.UserOrderDo:output_type -> UserOrderDoReply
	34, // 75: BinanceUser.UserOrderDoTwo:output_type -> UserOrderDoReply
	36, // 76: BinanceUser.UserOrderDoHandlePrice:output_type -> UserOrderDoHandlePriceReply
	38, // 77: BinanceUser.PullFilData:output_type -> PullFilDataReply
	40, // 78: BinanceUser.GetFilData:output_type -> GetFilDataReply
	44, // 79: BinanceUser.GetUserBindData:output_type -> GetUserBindDataReply
	42, // 80: BinanceUser.GetBinanceTradersTrade:output_type -> GetBinanceTradersTradeReply
	47, // 81: BinanceUser.InsertUserBindData:output_type -> InsertUserBindDataReply
	49, // 82: BinanceUser.DeleteUserBindData:output_type -> DeleteUserBindDataReply
	51, // 83: BinanceUser.HandleP:output_type -> HandlePReply
