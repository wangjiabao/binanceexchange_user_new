...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_rawDesc = []byte{
	...
	0x32, 0xcb, 0x30, 0x0a, 0x0b, 0x42, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x64, 0x65, 0x72, 0x5f, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x6d, 0x6f, 0x6e, 0x65, 0x79, 0x42, 0x4b,
	0x0a, 0x12, 0x61, 0x70, 0x69, 0x2e, 0x62, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x64, 0x61, 0x74,
	0x61, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x33, 0x62, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x65,
	0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69,
	0x2f, 0x62, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
...
var file_api_binanceexchange_user_v1_binanceexchange_user_proto_depIdxs = []int32{
	...
	1,  // 64: BinanceUser.GetUser:output_type -> GetUserReply
	3,  // 65: BinanceUser.PullUserDeposit:output_type -> PullUserDepositReply
	3,  // 66: BinanceUser.PullUserDeposit2:output_type -> PullUserDepositReply
	5,  // 67: BinanceUser.PullUserCredentialsBsc:output_type -> PullUserCredentialsBscReply
	7,  // 68: BinanceUser.BindTrader:output_type -> BindTraderReply
	25, // 69: BinanceUser.ListenTraderAndUserOrder:output_type -> ListenTraderAndUserOrderReply
	25, // 70: BinanceUser.ListenTraderAndUserOrderNew:output_type -> ListenTraderAndUserOrderReply
	25, // 71: BinanceUser.ListenOrderNew:output_type -> ListenTraderAndUserOrderReply
	23, // 72: BinanceUser.OrderHandle:output_type -> OrderHandleReply
	23, // 73: BinanceUser.OrderHandleTwo:output_type -> OrderHandleReply
	9,  // 74: BinanceUser.Analyze:output_type -> AnalyzeReply
	11, // 75: BinanceUser.CloseOrderAfterBind:output_type -> CloseOrderAfterBindReply
	11, // 76: BinanceUser.CloseOrderAfterBindTwo:output_type -> CloseOrderAfterBindReply
	13, // 77: BinanceUser.InitOrderAfterBind:output_type -> InitOrderAfterBindReply
	13, // 78: BinanceUser.InitOrderAfterBindTwo:output_type -> InitOrderAfterBindReply
	13, // 79: BinanceUser.InitOrderAfterBindTwoNew:output_type -> InitOrderAfterBindReply
	15, // 80: BinanceUser.HandleChange:output_type -> OverOrderAfterBindReply
	15, // 81: BinanceUser.OverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 82: BinanceUser.OverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	15, // 83: BinanceUser.AdminOverOrderAfterBind:output_type -> OverOrderAfterBindReply
	15, // 84: BinanceUser.AdminOverOrderAfterBindTwo:output_type -> OverOrderAfterBindReply
	17, // 85: BinanceUser.AdminOverOrderTwoByInfo:output_type -> AdminOverOrderTwoByInfoReply
	19, // 86: BinanceUser.OrderAdminTwo:output_type -> OrderAdminTwoReply
	21, // 87: BinanceUser.ExchangeUserLeverAge:output_type -> ExchangeUserLeverAgeReply
	27, // 88: BinanceUser.PullTradingBoxOpen:output_type -> PullTradingBoxOpenReply
	29, // 89: BinanceUser.SettleTradingBoxOpen:output_type -> SettleTradingBoxOpenReply
	31, // 90: BinanceUser.PullBinanceTradeHistory:output_type -> PullBinanceTradeHistoryReply
	33, // 91: BinanceUser.GetBinanceTraderPosition:output_type -> GetBinanceTraderPositionHistoryReply
	34, // 92: BinanceUser.UserOrderDo:output_type -> UserOrderDoReply
	34, // 93: BinanceUser.UserOrderDoTwo:output_type -> UserOrderDoReply
	36, // 94: BinanceUser.UserOrderDoHandlePrice:output_type -> UserOrderDoHandlePriceReply
	38, // 95: BinanceUser.PullFilData:output_type -> PullFilDataReply
	40, // 96: BinanceUser.GetFilData:output_type -> GetFilDataReply
	44, // 97: BinanceUser.GetUserBindData:output_type -> GetUserBindDataReply
	42, // 98: BinanceUser.GetBinanceTradersTrade:output_type -> GetBinanceTradersTradeReply
	47, // 99: BinanceUser.InsertUserBindData:output_type -> InsertUserBindDataReply
	49, // 100: BinanceUser.DeleteUserBindData:output_type -> DeleteUserBindDataReply
	51, // 101: BinanceUser.HandleP:output_type -> HandlePReply
	53, // 102: BinanceUser.GetUserAndTrader:output_type -> GetUserAndTraderReply
	55, // 103: BinanceUser.GetTraderPosition:output_type -> GetTraderPositionReply
	57, // 104: BinanceUser.GetUserPosition:output_type -> GetUserPositionReply
	59, // 105: BinanceUser.OpenPosition:output_type -> OpenPositionReply
	61, // 106: BinanceUser.InitPosition:output_type -> InitPositionReply
	65, // 107: BinanceUser.UnbindAndClosePosition:output_type -> UnbindAndClosePositionReply
	63, // 108: BinanceUser.ListenTraderPositionSendEmail:output_type -> ListenTraderPositionSendEmailReply
	67, // 109: BinanceUser.WithdrawToOkx:output_type -> WithdrawToOkxReply
	69, // 110: BinanceUser.PullTraderBaseMoney:output_type -> PullTraderBaseMoneyReply
...
func file_api_binanceexchange_user_v1_binanceexchange_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes[80].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes[81].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes[82].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes[83].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_binanceexchange_user_v1_binanceexchange_user_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
