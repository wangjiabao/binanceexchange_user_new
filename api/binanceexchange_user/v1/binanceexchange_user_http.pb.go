...
const OperationBinanceUserInitPosition = "/BinanceUser/InitPosition"
...
const OperationBinanceUserListenTraderPositionSendEmail = "/BinanceUser/ListenTraderPositionSendEmail"
const OperationBinanceUserListenTraderSendEmail = "/BinanceUser/ListenTraderSendEmail"
const OperationBinanceUserOpenPosition = "/BinanceUser/OpenPosition"
...
const OperationBinanceUserPullTraderBaseMoney = "/BinanceUser/PullTraderBaseMoney"
...
const OperationBinanceUserUnbindAndClosePosition = "/BinanceUser/UnbindAndClosePosition"
...
const OperationBinanceUserWithdrawToOkx = "/BinanceUser/WithdrawToOkx"
...
type BinanceUserHTTPServer interface {
	...
	ListenTraderSendEmail(context.Context, *ListenTraderPositionSendEmailRequest) (*ListenTraderPositionSendEmailReply, error)
...
func RegisterBinanceUserHTTPServer(s *http.Server, srv BinanceUserHTTPServer) {
	...
	r.POST("/api/binanceexchange_user/open_positions", _BinanceUser_OpenPosition0_HTTP_Handler(srv))
	r.POST("/api/binanceexchange_user/init_positions", _BinanceUser_InitPosition0_HTTP_Handler(srv))
	r.POST("/api/binanceexchange_user/unbind_and_close_positions", _BinanceUser_UnbindAndClosePosition0_HTTP_Handler(srv))
	r.GET("/api/binanceexchange_user/listen_trader_position_send_email", _BinanceUser_ListenTraderPositionSendEmail0_HTTP_Handler(srv))
	r.GET("/api/binanceexchange_user/withdraw_to_okx", _BinanceUser_WithdrawToOkx0_HTTP_Handler(srv))
	r.GET("/api/binanceexchange_user/pull_trader_base_money", _BinanceUser_PullTraderBaseMoney0_HTTP_Handler(srv))
	r.GET("/api/binanceexchange_user/listen_trader_send_email", _BinanceUser_ListenTraderSendEmail0_HTTP_Handler(srv))
}
...
func _BinanceUser_OpenPosition0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in OpenPositionRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBinanceUserOpenPosition)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.OpenPosition(ctx, req.(*OpenPositionRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*OpenPositionReply)
		return ctx.Result(200, reply)
	}
}

func _BinanceUser_InitPosition0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in InitPositionRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBinanceUserInitPosition)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.InitPosition(ctx, req.(*InitPositionRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*InitPositionReply)
		return ctx.Result(200, reply)
	}
}

func _BinanceUser_UnbindAndClosePosition0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UnbindAndClosePositionRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBinanceUserUnbindAndClosePosition)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UnbindAndClosePosition(ctx, req.(*UnbindAndClosePositionRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UnbindAndClosePositionReply)
		return ctx.Result(200, reply)
	}
}

func _BinanceUser_ListenTraderPositionSendEmail0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListenTraderPositionSendEmailRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationBinanceUserListenTraderPositionSendEmail)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListenTraderPositionSendEmail(ctx, req.(*ListenTraderPositionSendEmailRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListenTraderPositionSendEmailReply)
		return ctx.Result(200, reply)
	}
}

func _BinanceUser_WithdrawToOkx0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in WithdrawToOkxRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationBinanceUserWithdrawToOkx)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.WithdrawToOkx(ctx, req.(*WithdrawToOkxRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*WithdrawToOkxReply)
		return ctx.Result(200, reply)
	}
}

func _BinanceUser_PullTraderBaseMoney0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in PullTraderBaseMoneyRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationBinanceUserPullTraderBaseMoney)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.PullTraderBaseMoney(ctx, req.(*PullTraderBaseMoneyRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*PullTraderBaseMoneyReply)
		return ctx.Result(200, reply)
	}
}

func _BinanceUser_ListenTraderSendEmail0_HTTP_Handler(srv BinanceUserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListenTraderPositionSendEmailRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationBinanceUserListenTraderSendEmail)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListenTraderSendEmail(ctx, req.(*ListenTraderPositionSendEmailRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type BinanceUserHTTPClient interface {
	...
	InitPosition(ctx context.Context, req *InitPositionRequest, opts ...http.CallOption) (rsp *InitPositionReply, err error)
	...
	ListenTraderPositionSendEmail(ctx context.Context, req *ListenTraderPositionSendEmailRequest, opts ...http.CallOption) (rsp *ListenTraderPositionSendEmailReply, err error)
	ListenTraderSendEmail(ctx context.Context, req *ListenTraderPositionSendEmailRequest, opts ...http.CallOption) (rsp *ListenTraderPositionSendEmailReply, err error)
	OpenPosition(ctx context.Context, req *OpenPositionRequest, opts ...http.CallOption) (rsp *OpenPositionReply, err error)
	...
	PullTraderBaseMoney(ctx context.Context, req *PullTraderBaseMoneyRequest, opts ...http.CallOption) (rsp *PullTraderBaseMoneyReply, err error)
	...
	UnbindAndClosePosition(ctx context.Context, req *UnbindAndClosePositionRequest, opts ...http.CallOption) (rsp *UnbindAndClosePositionReply, err error)
	...
	WithdrawToOkx(ctx context.Context, req *WithdrawToOkxRequest, opts ...http.CallOption) (rsp *WithdrawToOkxReply, err error)
}
...
func (c *BinanceUserHTTPClientImpl) InitPosition(ctx context.Context, in *InitPositionRequest, opts ...http.CallOption) (*InitPositionReply, error) {
	var out InitPositionReply
	pattern := "/api/binanceexchange_user/init_positions"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBinanceUserInitPosition))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BinanceUserHTTPClientImpl) ListenTraderPositionSendEmail(ctx context.Context, in *ListenTraderPositionSendEmailRequest, opts ...http.CallOption) (*ListenTraderPositionSendEmailReply, error) {
	var out ListenTraderPositionSendEmailReply
	pattern := "/api/binanceexchange_user/listen_trader_position_send_email"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationBinanceUserListenTraderPositionSendEmail))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BinanceUserHTTPClientImpl) ListenTraderSendEmail(ctx context.Context, in *ListenTraderPositionSendEmailRequest, opts ...http.CallOption) (*ListenTraderPositionSendEmailReply, error) {
	var out ListenTraderPositionSendEmailReply
	pattern := "/api/binanceexchange_user/listen_trader_send_email"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationBinanceUserListenTraderSendEmail))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BinanceUserHTTPClientImpl) OpenPosition(ctx context.Context, in *OpenPositionRequest, opts ...http.CallOption) (*OpenPositionReply, error) {
	var out OpenPositionReply
	pattern := "/api/binanceexchange_user/open_positions"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBinanceUserOpenPosition))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BinanceUserHTTPClientImpl) PullTraderBaseMoney(ctx context.Context, in *PullTraderBaseMoneyRequest, opts ...http.CallOption) (*PullTraderBaseMoneyReply, error) {
	var out PullTraderBaseMoneyReply
	pattern := "/api/binanceexchange_user/pull_trader_base_money"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationBinanceUserPullTraderBaseMoney))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BinanceUserHTTPClientImpl) UnbindAndClosePosition(ctx context.Context, in *UnbindAndClosePositionRequest, opts ...http.CallOption) (*UnbindAndClosePositionReply, error) {
	var out UnbindAndClosePositionReply
	pattern := "/api/binanceexchange_user/unbind_and_close_positions"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBinanceUserUnbindAndClosePosition))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BinanceUserHTTPClientImpl) WithdrawToOkx(ctx context.Context, in *WithdrawToOkxRequest, opts ...http.CallOption) (*WithdrawToOkxReply, error) {
	var out WithdrawToOkxReply
	pattern := "/api/binanceexchange_user/withdraw_to_okx"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationBinanceUserWithdrawToOkx))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
